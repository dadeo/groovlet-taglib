 ...
 */
package d4d30.groovlet.taglib.standard
...
class TagLibGroovyServletTest extends TestCase {
  ...
  private TagLibGroovyServlet createServlet() {
    ...
    servletConfig.addInitParameter('tagLibs', """
        d4d30.groovlet.taglib.standard.internal.support.FooTagLib
        d4d30.groovlet.taglib.standard.internal.support.BarTagLib
      """)
